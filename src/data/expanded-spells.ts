...
export const expandedSpells: Spell[] = [
  ...
  },
  {
    ...
    castingTime: "1 action",
    range: "Touch",
    components: { verbal: true, somatic: true, material: true, materialDescription: "gold dust worth at least 25 gp, which the spell consumes" },
  ...
  },
  {
    ...
    castingTime: "1 minute",
    range: "Self",
    components: { verbal: true, somatic: true, material: true, materialDescription: "specially marked sticks, bones, or similar tokens worth at least 25 gp" },
    duration: "Instantaneous",
    concentration: false,
    ritual: true,
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: "A line of strong wind 60 feet long and 10 feet wide blasts from you in a direction you choose for the spell's duration. Each creature that starts its turn in the line or that enters it during its turn must succeed on a Strength saving throw or be pushed 15 feet away from you in a direction following the line. Any creature in the line must spend 2 feet of movement for every 1 foot it moves when moving closer to you.",
  ...
  },
  {
    ...
    castingTime: "1 minute",
    range: "30 feet",
    components: { verbal: true, somatic: true, material: true, materialDescription: "a small bit of honeycomb and jade dust worth at least 10 gp, which the spell consumes" },
    duration: "Until dispelled",
    concentration: false,
    ritual: true,
  ...
  },
  {
    ...
    castingTime: "1 action",
    range: "Touch",
    components: { verbal: true, somatic: true, material: true, materialDescription: "a pair of platinum rings worth at least 50 gp each, which you and the target must wear for the duration" },
    duration: "1 hour",
    concentration: false,
    ritual: false,
  ...
  },
  {
    ...
    castingTime: "10 minutes",
    range: "1 mile",
    components: { verbal: true, somatic: true, material: true, materialDescription: "a focus worth at least 100 gp, either a jeweled horn for hearing or a glass eye for seeing" },
    duration: "Concentration, up to 10 minutes",
    concentration: true,
    ritual: false,
  ...
  // ===== RACIAL SPELLS (Added) =====
  {
    ...
    castingTime: "1 action",
    range: "60 feet",
    components: { verbal: true, somatic: true, material: true, materialDescription: "a small leather loop or a piece of golden wire bent into a cup shape with a long shank" },
    duration: "Concentration, up to 10 minutes",
    concentration: true,
    ritual: false,
  ...
  },
  {
    ...
    classes: ["sorcerer", "warlock", "wizard"],
    subclasses: ["Arcane Trickster", "Eldritch Knight", "Aberrant Mind"],
    source: "TCoE",
    edition: "5e",
    version: 1,
  },
