...
export const ITEMS: Item[] = [
  {
    ...
    "name": "Longsword",
    "type": "Weapon",
    "description": "A versatile martial weapon with a long blade. Can be wielded with one or two hands.",
    "magical": false,
  ...
  },
  {
    ...
    "name": "Leather Armor",
    "type": "Armor",
    "description": "Light armor made from carefully tanned and stitched leather. AC 11 + Dex modifier.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 10,
  ...
  },
  {
    ...
    "name": "Chainmail",
    "type": "Armor",
    "description": "Heavy armor made of interlocking metal rings. AC 16, disadvantage on Stealth.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 75,
  ...
  },
  {
    ...
    "type": "Wondrous Item",
    "description": "This 60-foot length of silk rope weighs 3 pounds and can hold up to 3,000 pounds. If you hold one end of the rope and use an action to speak the command word, the rope animates. As a bonus action, you can command the other end to move toward a destination you choose.",
    "magical": true,
    "rarity": "Uncommon",
    "requiresAttunement": false,
    "weight": 3,
  ...
  },
  {
    ...
    "type": "Wondrous Item",
    "description": "Magical tattoo that covers your hand and forearm. Your unarmed strikes are magical +1. Bonus action to activate for 1 min: unarmed strikes have 15ft reach and deal +1d6 force damage.",
    "magical": true,
    "rarity": "Uncommon",
    "requiresAttunement": true,
  ...
  },
  {
    ...
    "name": "Greatsword",
    "type": "Weapon",
    "description": "A heavy, two-handed martial melee weapon favored by warriors for its tremendous damage potential.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 50,
  ...
  },
  {
    ...
    "name": "Rapier",
    "type": "Weapon",
    "description": "An elegant martial melee weapon that emphasizes precision over brute force.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 25,
  ...
  },
  {
    ...
    "name": "Shortbow",
    "type": "Weapon",
    "description": "A simple ranged weapon that fires arrows. It requires two hands to use.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 25,
  ...
  },
  {
    ...
    "name": "Light Crossbow",
    "type": "Weapon",
    "description": "A simple ranged weapon that fires bolts. It requires two hands to load and fire.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 25,
  ...
  },
  {
    ...
    "name": "Heavy Crossbow",
    "type": "Weapon",
    "description": "A martial ranged weapon that packs tremendous punch but requires careful loading.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 50,
  ...
  },
  {
    ...
    "name": "Battleaxe",
    "type": "Weapon",
    "description": "A versatile martial melee weapon that can be wielded with one or two hands.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 10,
  ...
  },
  {
    ...
    "name": "Warhammer",
    "type": "Weapon",
    "description": "A versatile martial melee weapon favored by dwarves and clerics of war deities.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 15,
  ...
  },
  {
    ...
    "type": "Armor",
    "description": "Made from tough but flexible leather, studded leather is reinforced with close-set rivets or spikes. AC: 12 + Dex modifier.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 45,
  ...
  },
  {
    ...
    "name": "Chain Mail",
    "type": "Armor",
    "description": "Made of interlocking metal rings, chain mail includes a layer of quilted fabric worn underneath the mail to prevent chafing and to cushion the impact of blows. AC: 16. Disadvantage on Stealth checks.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 75,
  ...
  },
  {
    ...
    "name": "Plate Armor",
    "type": "Armor",
    "description": "Plate consists of shaped, interlocking metal plates to cover the entire body. A suit of plate includes gauntlets, heavy leather boots, a visored helmet, and thick layers of padding underneath the armor. AC: 18. Disadvantage on Stealth checks.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 1500,
  ...
  },
  {
    ...
    "weight": 1,
    "properties": [
      "Double walking speed (10 min/day)",
  ...
  },
  {
    ...
    "name": "Staff of Power",
    "type": "Staff",
    "description": "This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls made with it. While holding it, you gain a +2 bonus to Armor Class, saving throws, and spell attack rolls. The staff has 20 charges for various properties.",
    "magical": true,
    "rarity": "Very Rare",
    "requiresAttunement": true,
    "weight": 4,
  ...
  },
  {
    ...
    "type": "Scroll",
    "description": "This scroll contains the Revivify spell (3rd level). Using the scroll still consumes the material components (diamonds worth 300 gp).",
    "magical": true,
    "rarity": "Uncommon",
    "requiresAttunement": false,
    "properties": [
      "Single use",
      "Revivify (3rd level)",
      "Requires diamonds worth 300 gp"
    ],
    "source": "Official",
    "edition": "Both",
    "version": 1
  },
  {
    ...
    "name": "Bedroll",
    "type": "Adventuring Gear",
    "description": "You never know where you're going to sleep, and a bedroll helps you get better sleep in a hayloft or on the cold ground.",
    "magical": false,
    "requiresAttunement": false,
    "cost": {
      "amount": 1,
