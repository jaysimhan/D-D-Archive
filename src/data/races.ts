...
export const RACES: Race[] = [
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Fey Ancestry",
        "description": "Advantage against charm, no sleep magic."
      },
      {
      ...
      {
        "name": "Perfect Observation",
        "description": "Proficiency in Investigation."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Spider Climb",
        "description": "Climb speed equal to walking speed. At 3rd level, move up, down, across vertical surfaces and ceilings hands-free."
      },
      {
        "name": "Vampiric Bite",
        "description": "Natural weapon (1d4 piercing). Advantage on attack if under half HP. Empower self on hit."
      },
      {
        "name": "Deathless Nature",
        "description": "Don't need to breathe."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Deathless Nature",
        "description": "Advantage on saves vs disease/poison, resistance to poison. No sleep, eat, drink, breathe."
      },
      {
      ...
      },
      {
        ...
        "description": "Add d6 to skill check (proficiency times/long rest)."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Eerie Token",
        "description": "Remove a lock of hair or fingernail to create a telepathic token."
      },
      {
        "name": "Hex Magic",
        "description": "Cast Disguise Self and Hex with this trait. Intelligence, Wisdom, or Charisma is your spellcasting ability."
      },
      {
        "name": "Fey Ancestry",
        "description": "Advantage against charm, no sleep magic."
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Flexible Ability Score",
        "description": "Increase one other ability score by 1."
      },
      {
        "name": "Constructed Resilience",
        "description": "Advantage on saves vs poison; resistance to poison; don't need to eat, drink, or breathe; immune to disease; don't sleep."
      },
      {
        "name": "Sentry's Rest",
        "description": "You enter a motionless, conscious state for 6 hours instead of sleeping."
      },
      {
        "name": "Integrated Protection",
        "description": "+1 to Armor Class; armor must be incorporated into your body."
      },
      {
        "name": "Specialized Design",
        "description": "One skill proficiency and one tool proficiency of your choice."
      }
    ],
    "languages": [
      "Common"
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Claws",
        "description": "1d4 + Str slashing unarmed strike."
      },
      {
        "name": "Hunter's Instincts",
        "description": "Proficiency in Athletics, Intimidation, Perception, or Survival."
      },
      {
        "name": "Daunting Roar",
        "description": "Bonus action fear effect (Con save) 10ft radius."
      },
      {
        "name": "Darkvision",
        "description": "60 ft."
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Ram",
        "description": "1d4 + Str bludgeoning unarmed strike."
      },
      {
        "name": "Magic Resistance",
      ...
      {
        "name": "Reveler",
        "description": "Proficiency in Performance and Persuasion, and one instrument."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Powerful Build",
        "description": "Count as one size larger for carry/lift."
      },
      {
        "name": "Loxodon Serenity",
        "description": "Advantage on saves vs charmed/frightened."
      },
      {
        "name": "Natural Armor",
        "description": "AC = 12 + Con modifier."
      },
      {
        "name": "Trunk",
        "description": "Can grapple, lift, use objects with trunk (reach 5ft)."
      },
      {
        "name": "Keen Smell",
        "description": "Advantage on Perception/Survival/Investigation checks involving smell."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "description": "Thaumaturgy cantrip; Hellish Rebuke at 3rd; Darkness at 5th."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Hold Breath",
        "description": "Hold breath for 1 hour."
      },
      {
        "name": "Natural Armor",
        "description": "Base AC 17 (Dex doesn't affect). Cannot wear armor."
      },
      {
        "name": "Shell Defense",
        "description": "Action to withdraw into shell (+4 AC, prone, restrained)."
      },
      {
        "name": "Survival Instinct",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Guiding Light",
        "description": "Cast Light cantrip (nose source)."
      },
      {
        "name": "Antler Defense",
        "description": "+1 to AC when not using shield."
      },
      {
        "name": "Hooves",
        "description": "1d4 + Str bludgeoning unarmed strike."
      },
      {
        ...
        "description": "Proficiency in History."
      },
      {
        "name": "Born to Navigate",
        "description": "Proficiency in Navigator's tools; always know north."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Size Choice",
        "description": "You are Small or Medium (your choice)."
      },
      {
        "name": "Darkvision",
        "description": "60 ft."
      ...
      {
        "name": "Pounce",
        "description": "If you move 20ft straight and hit, target must succeed Str save or prone."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Photosynthesis",
        "description": "Don't need to eat if you spend 4 hours in sunlight."
      },
      {
        "name": "Life in the Outdoors",
        "description": "Proficiency in Survival and Nature."
      },
      {
        "name": "Natural Armor",
        "description": "AC 13 + Dex (max 2)."
      },
      {
        "name": "Plant Speak",
        "description": "Can cast Speak with Plants once per long rest."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Chilled Anatomy",
        "description": "Immunity to Cold damage; Vulnerability to Fire."
      },
      {
        "name": "Amorphous Snow",
        "description": "Squeeze through 1 inch gaps."
      },
      {
        "name": "Construct Nature",
        "description": "Don't eat, drink, breathe, sleep."
      },
      {
        "name": "Flash of Frost",
        "description": "Reaction to deal 1d6 cold to attacker within 5ft."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Nimble Escape",
        "description": "Disengage or Hide as bonus action."
      },
      {
        "name": "Auntie's Favor",
        "description": "Proficiency in one skill: Sleight of Hand, Stealth, or Survival."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Flight",
        "description": "Fly speed 30 ft."
      },
      {
        "name": "Fey Ancestry",
        "description": "Adv vs charm, no sleep magic."
      },
      {
        "name": "Pester",
        "description": "Can cast Faerie Fire once per long rest."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Inner Flame",
        "description": "Produce Flame cantrip. Cha is spellcasting ability."
      },
      {
        "name": "Living Fire",
        "description": "Resistance to Fire damage."
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Thoughtweft",
        "description": "Advantage on attacks if an ally is within 5ft."
      },
      {
        "name": "Halfling Luck",
        "description": "Reroll 1s on d20."
      },
      {
        "name": "Brave",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Shapechanger",
        "description": "Change appearance as an action."
      },
      {
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Chill Touch",
        "description": "Know the Chill Touch cantrip."
      },
      {
        "name": "Ice Walk",
        "description": "Ignore difficult terrain composed of ice or snow."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      },
      {
        ...
        "description": "Proficiency in Persuasion and Navigator's Tools."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      ...
      {
        "name": "Bite",
        "description": "1d6 + Str piercing damage unarmed strike."
      },
      {
        "name": "Thick Fur",
        "description": "Natural Armor: AC = 12 + Con modifier."
      },
      {
        "name": "Keen Smell",
        "description": "Advantage on Perception checks involving smell."
      }
    ],
    "languages": [
      "Common",
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Amorphous",
        "description": "You can squeeze through a space as narrow as 1 inch wide, provided you are wearing and carrying nothing. Advantage on grapple escape."
      },
      {
        "name": "Darkvision",
        "description": "60 ft."
      ...
      },
      {
        ...
        "description": "Resistance to acid and poison damage; advantage on saves vs poison."
      },
      {
        "name": "Shape Self",
        "description": "Reshape body, extrude pseudopod (10ft reach for manipulation)."
      }
    ],
    "languages": [
      "Common"
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Astral Fire",
        "description": "You know one of the following cantrips: dancing lights, light, or sacred flame. You can change it when you finish a long rest. Intelligence, Wisdom, or Charisma is your spellcasting ability for it (choose when you select this race)."
      },
      {
        "name": "Darkvision",
        "description": "60 ft."
      ...
      {
        "name": "Fey Ancestry",
        "description": "Advantage on saves vs charm, magic can't put you to sleep."
      },
      {
        "name": "Keen Senses",
        "description": "Proficiency in Perception."
      ...
      {
        "name": "Starlight Step",
        "description": "Bonus action teleport 30 ft. PB/long rest."
      },
      {
        "name": "Astral Trance",
        "description": "Finish long rest in 4 hours."
      }
    ],
    "racialSpellChoices": [
      {
  ...
  },
  {
    ...
    "traits": [
      {
        "name": "Draconic Cry",
        "description": "Bonus action to give advantage on attacks against enemies within 10 ft of you. PB/long rest."
      },
      {
        "name": "Kobold Legacy (Draconic Sorcery)",
        "description": "You know one cantrip from the sorcerer spell list. INT, WIS, or CHA is your spellcasting ability."
      },
      {
        "name": "Darkvision",
        "description": "60 ft."
    ...
    "traits": [
      {
        ...
        "description": "You learn one language and one skill proficiency or tool proficiency."
      },
      {
        "name": "Martial Prodigy",
        "description": "Proficiency with light/medium armor, shortswords, longswords, greatswords."
      },
      {
        "name": "Githyanki Psionics",
        "description": "Mage Hand (invisible) at 1st, Jump at 3rd, Misty Step at 5th."
      }
    ],
    "racialKnownSpells": [
      {
    ...
    "traits": [
      {
        ...
        "description": "Advantage on saves vs charm and fright."
      },
      {
        "name": "Githzerai Psionics",
        "description": "Mage Hand (invisible) at 1st, Shield at 3rd, Detect Thoughts at 5th."
      }
    ],
    "racialKnownSpells": [
      {
